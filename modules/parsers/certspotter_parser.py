#!/usr/bin/env python3
"""Parser stub for certspotter.

Implement `parse_certspotter_output` or similar functions. The top-level parse_tool_envelope dispatcher
...
"""
def parse_certspotter_output(envelope, run_dir=None):
    out = []
    ...
    if isinstance(pf, list) and pf:
        for p in pf:
            out.append({
                "type": p.get("type") or "certspotter-vuln",
