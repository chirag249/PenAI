#!/usr/bin/env python3
"""Parser stub for nikto.

Implement `parse_nikto_output` or similar functions. The top-level parse_tool_envelope dispatcher
...
"""
def parse_nikto_output(envelope, run_dir=None):
    out = []
