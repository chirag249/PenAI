#!/usr/bin/env python3
"""Parser stub for crtsh.

Implement `parse_crtsh_output` or similar functions. The top-level parse_tool_envelope dispatcher
...
"""
def parse_crtsh_output(envelope, run_dir=None):
    out = []
