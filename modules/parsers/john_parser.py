#!/usr/bin/env python3
"""Parser stub for john.

Implement `parse_john_output` or similar functions. The top-level parse_tool_envelope dispatcher
...
"""
def parse_john_output(envelope, run_dir=None):
    out = []
