#!/usr/bin/env python3
"""Parser stub for dirb.

Implement `parse_dirb_output` or similar functions. The top-level parse_tool_envelope dispatcher
...
"""
def parse_dirb_output(envelope, run_dir=None):
    out = []
