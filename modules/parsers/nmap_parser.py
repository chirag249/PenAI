#!/usr/bin/env python3
"""Parser stub for nmap.

Implement `parse_nmap_output` or similar functions. The top-level parse_tool_envelope dispatcher
...
"""
def parse_nmap_output(envelope, run_dir=None):
    out = []
