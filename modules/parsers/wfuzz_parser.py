#!/usr/bin/env python3
"""Parser stub for wfuzz.

Implement `parse_wfuzz_output` or similar functions. The top-level parse_tool_envelope dispatcher
...
"""
def parse_wfuzz_output(envelope, run_dir=None):
    out = []
