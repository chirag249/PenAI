#!/usr/bin/env python3
"""Parser stub for amass.

Implement `parse_amass_output` or similar functions. The top-level parse_tool_envelope dispatcher
...
"""
def parse_amass_output(envelope, run_dir=None):
    out = []
