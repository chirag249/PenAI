#!/usr/bin/env python3
"""Parser stub for zmap.

Implement `parse_zmap_output` or similar functions. The top-level parse_tool_envelope dispatcher
...
"""
def parse_zmap_output(envelope, run_dir=None):
    out = []
