#!/usr/bin/env python3
"""Parser stub for w3af.

Implement `parse_w3af_output` or similar functions. The top-level parse_tool_envelope dispatcher
...
"""
def parse_w3af_output(envelope, run_dir=None):
    out = []
