#!/usr/bin/env python3
"""Parser stub for ffuf.

Implement `parse_ffuf_output` or similar functions. The top-level parse_tool_envelope dispatcher
...
"""
def parse_ffuf_output(envelope, run_dir=None):
    out = []
