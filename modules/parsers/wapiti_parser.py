#!/usr/bin/env python3
"""Parser stub for wapiti.

Implement `parse_wapiti_output` or similar functions. The top-level parse_tool_envelope dispatcher
...
"""
def parse_wapiti_output(envelope, run_dir=None):
    out = []
    ...
    if isinstance(pf, list) and pf:
        for p in pf:
            out.append({
                "type": p.get("type") or "wapiti-vuln",
