#!/usr/bin/env python3
"""Parser stub for hydra.

Implement `parse_hydra_output` or similar functions. The top-level parse_tool_envelope dispatcher
...
"""
def parse_hydra_output(envelope, run_dir=None):
    out = []
