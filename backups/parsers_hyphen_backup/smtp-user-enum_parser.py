#!/usr/bin/env python3
"""Parser stub for smtp-user-enum.

Implement `parse_smtp-user-enum_output` or similar functions. The top-level parse_tool_envelope dispatcher
...
"""
def parse_smtp-user-enum_output(envelope, run_dir=None):
    out = []
