#!/usr/bin/env python3
"""Parser stub for graphql-fuzzer.

Implement `parse_graphql-fuzzer_output` or similar functions. The top-level parse_tool_envelope dispatcher
...
"""
def parse_graphql-fuzzer_output(envelope, run_dir=None):
    out = []
