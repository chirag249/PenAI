...
def main():
    ...
    p.add_argument("--config", default="config/train_transformer.yaml")
    ...
    # Call transformer trainer
    run_dir = os.path.dirname(model_dir.rstrip("/")) if model_dir.endswith("/generated") else model_dir
    res = train_transformer_model(run_dir, examples, keyword_only=args.keyword_only)
